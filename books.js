        ...
        <div className="card-body">
          ...
          <table className="table">
            <tbody>
              ...
              {/* Render the "Link Here" cell only */}
              <tr>
                <td className="text-success font-weight-bold">Link:</td>
                <td>
                  <a href={data.website} target="_blank" rel="noopener noreferrer" className="link-style">
                    Link Here
                  </a>
                </td>
              </tr>
